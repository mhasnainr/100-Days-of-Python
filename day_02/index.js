...
let quote = "The harder you work, the luckier you become";
console.log(`Sir Ahmed Saya always says, '${quote}'`);
//
...
let famous_person = "Zarak Mushtaq";
console.log(`Sir ${famous_person} always says, 'Believe in hardwork'`);
//
